...
function handleKanbanJson(config) {
  return (req, res) => {
    ...
    try {
      ...
      // 附上项目名（kanbanRepo 的目录名），供面板在按钮上标识"哪个项目的看板"
      const repoName = file ? basename(dirname(file)) : null;
