...
function createKanbanSource(getRepoPath) {
  let snapshot = null;
  ...
  const load = () => {
    ...
    fetch(`/team-ai/kanban.json${query}`, { cache: "no-store" }).then(async (res) => {
...
function KanbanBoard({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontWeight: 700, fontSize: 15, marginBottom: 4 }, children: [
      "AI \u56E2\u961F\u770B\u677F",
      state.repoName ? ` \xB7 ${state.repoName}` : ""
    ] }),
...
function KanbanFooterAction({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { position: "relative" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      ...
      {
        type: "button",
        title: repoName ? `\u56E2\u961F\u770B\u677F \xB7 ${repoName}` : "\u56E2\u961F\u770B\u677F",
        onClick: () => setOpen((v) => !v),
...
var inject = ["slots", "workspaces", "sessions"];
function apply(ctx) {
  ...
  const getRepoPath = () => {
    ...
    const bySession = sessionId ? items.find((w) => w.sessionIds?.includes(sessionId)) : void 0;
